...
export function parseSize(value: SizeInput | undefined, fallback: number): number {
  if (value === undefined) {
    return fallback;
  }
...
export function toBuffer(value: string | Uint8Array | ArrayBuffer | ArrayBufferView): Buffer {
...
export function inferTransport(httpVersionMajor: number, secure: boolean): RequestTransport {
